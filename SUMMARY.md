...
* [Setting Up Verifiers/Logins](direct-auth/setting-up-verifiers-logins/README.md)
  * [Setting up a proxy provider - Auth0](direct-auth/setting-up-verifiers-logins/setting-up-a-proxy-provider-auth0.md)
